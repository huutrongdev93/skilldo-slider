...
<div class="slider-layer-item">
    <h5>Layer 5</h5>
    <div class="p-2">
        {!! \SkillDo\Form\Form::render(['name' => 'caption[layer5][text]', 'type' => 'text', 'label' => 'Text layer 5'], $caption['layer5']['text']) !!}
        {!! \SkillDo\Form\Form::render(['name' => 'caption[layer5][color]', 'type' => 'color', 'label' => 'Color layer 5'], $caption['layer5']['color']) !!}
    </div>
</div>
...
<div class="slider-layer-item">
    <h5>Layer 6</h5>
    <div class="p-2">
        {!! \SkillDo\Form\Form::render(['name' => 'caption[layer6][text]', 'type' => 'text', 'label' => 'Text layer 6'], $caption['layer6']['text']) !!}
        {!! \SkillDo\Form\Form::render(['name' => 'caption[layer6][color]', 'type' => 'color', 'label' => 'Color layer 6'], $caption['layer6']['color']) !!}
    </div>
</div>