...
<div class="tp-caption finewide_large_white customin customout tp-resizeme"
     ...
     color:{!! $caption['layer1']['color'] !!}">{!! $caption['layer1']['text'] !!}
</div>
...
<div class="tp-caption whitedivider3px customin customout tp-resizeme"
     ...
     data-end="4000"
     data-endspeed="500"
     style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;background-color:{!! $caption['layer2']['color'] !!};">&nbsp;
</div>
...
<div class="tp-caption finewide_medium_white randomrotate customout tp-resizeme"
     ...
     data-end="4000"
     data-endspeed="500"
     style="z-index: 4; max-width: auto; max-height: auto; white-space: nowrap;color:{!! $caption['layer3']['color'] !!}">{!! $caption['layer3']['text'] !!}
</div>