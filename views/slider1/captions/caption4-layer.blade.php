<div class="tp-caption huge_red customin customout"
     ...
     data-captionhidden="on" style="z-index:5;;color:{!! $layer4['color'] !!};background-color: {!! $layer4['bg'] !!}">{!! $layer4['text'] !!}
</div>
...
<div class="tp-caption middle_yellow customin customout"
     ...
     data-captionhidden="on" style="z-index:5;color:{!! $layer1['color'] !!}">{!! $layer1['text'] !!}
</div>
...
<div class="tp-caption huge_thin_yellow customin customout"
     ...
     data-endspeed="1500"
     data-endeasing="Power3.easeInOut"
     data-captionhidden="on" style="z-index:5;;color:{!! $layer2['color'] !!}">{!! $layer2['text'] !!}
</div>
...
<div class="tp-caption middle_yellow customin customout"
     ...
     data-captionhidden="on" style="z-index:5;;color:{!! $layer3['color'] !!}">{!! $layer3['text'] !!}
</div>
