...
<div class="tp-caption large_bold_white_25 customin customout tp-resizeme"
     ...
     style="z-index: 3;color:<?php echo $caption['layer1']['color'];?>"><?php echo $caption['layer1']['text'];?>
</div>
...
<div class="tp-caption medium_text_shadow customin customout tp-resizeme"
     ...
     data-endspeed="600"
     data-endeasing="Power0.easeIn"
     style="z-index: 4;color:<?php echo $caption['layer2']['color'];?>"><?php echo $caption['layer2']['text'];?>
</div>