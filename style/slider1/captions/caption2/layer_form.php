...
<div class="slider-layer-item">
    <h5>Layer 5</h5>
    <?php echo FormBuilder::render(['field' => 'caption[layer5][text]', 'type' => 'text', 'label' => 'Text layer 5'], $caption['layer5']['text']);?>
    <?php echo FormBuilder::render(['field' => 'caption[layer5][color]', 'type' => 'color', 'label' => 'Color layer 5'], $caption['layer5']['color']);?>
</div>

<div class="slider-layer-item">
    <h5>Layer 6</h5>
    <?php echo FormBuilder::render(['field' => 'caption[layer6][text]', 'type' => 'text', 'label' => 'Text layer 6'], $caption['layer6']['text']);?>
    <?php echo FormBuilder::render(['field' => 'caption[layer6][color]', 'type' => 'color', 'label' => 'Color layer 6'], $caption['layer6']['color']);?>
</div>