<div class="tp-caption huge_red customin customout"
     ...
     data-splitout=""
     data-endelementdelay="0" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:190;rotationZ:0;scaleX:10;scaleY:10;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
     data-end="90000" data-endspeed="1500" data-endeasing="Power3.easeInOut"
     data-captionhidden="on" style="z-index:5;;color:<?php echo $caption['layer4']['color'];?>;background-color: <?php echo $caption['layer4']['bg'];?>"><?php echo $caption['layer4']['text'];?>
</div>

<div class="tp-caption middle_yellow customin customout"
     data-x="110" data-y="180"
     data-splitin="chars"
     ...
     data-captionhidden="on" style="z-index:5;;color:<?php echo $caption['layer1']['color'];?>"><?php echo $caption['layer1']['text'];?>
</div>
...
<div class="tp-caption huge_thin_yellow customin customout"
     ...
     data-endspeed="1500"
     data-endeasing="Power3.easeInOut"
     data-captionhidden="on" style="z-index:5;;color:<?php echo $caption['layer2']['color'];?>"><?php echo $caption['layer2']['text'];?>
</div>
...
<div class="tp-caption middle_yellow customin customout"
     ...
     data-captionhidden="on" style="z-index:5;;color:<?php echo $caption['layer3']['color'];?>"><?php echo $caption['layer3']['text'];?>
</div>
